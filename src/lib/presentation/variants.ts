...
export const textLink = cva("", {
  variants: {
    kind: {
      link: "inline-flex min-h-touch items-center gap-[14px] border-ink border-b font-body text-[11px] font-medium tracking-[0.06em] uppercase after:text-[20px] after:font-normal after:content-['→'] after:transition-transform after:duration-200 after:ease-standard hover:after:translate-x-[5px]",
      control:
...
export const emptyState = cva("grid", {
  variants: {
    size: {
      page: "min-h-[60svh] place-items-center bg-surface-subtle px-page-gutter py-[clamp(60px,10vw,140px)] text-center",
      panel:
        "min-h-[340px] place-items-center border border-ink bg-surface-subtle px-5 py-[60px] text-center",
    },
  },
