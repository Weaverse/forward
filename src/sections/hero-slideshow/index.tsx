...
function HeroSlideshow({ children, stats, ...rest }: HeroSlideshowProps) {
  ...
  return (
    <section
      ...
      className="relative isolate grid min-h-[calc(100svh_-_var(--spacing-announcement)_-_var(--spacing-header-compact)_+_var(--header-inset,0px))] grid-rows-[1fr_auto] overflow-hidden bg-ink text-text-inverse md:min-h-[calc(100svh_-_var(--spacing-announcement)_-_var(--spacing-header)_+_var(--header-inset,0px))]"
    >
      <div
        aria-hidden
